...
import type { CompanyEvent, NewsIssue, SurpriseEvent } from "@/lib/types";
import type { MarketEvent } from "@/lib/event-catalog";
import { getIssueMood } from "@/lib/news-engine";
import { Button } from "./ui";

export function NewsPaperPopup({ issue, turn, companyEvents = [], surpriseEvent = null, autoOpen = true }: { issue: NewsIssue; turn: number; companyEvents?: CompanyEvent[]; surpriseEvent?: SurpriseEvent|null; autoOpen?: boolean }) {
